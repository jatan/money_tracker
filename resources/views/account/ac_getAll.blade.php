	...
	<table class="table table-hover">
		...
		<tr>
			<th style="text-align: center;">{{strtoupper($allAccounts[0]->bank_name)}}
				...
				<button class="btn btn-warning" style="margin: 0 10px;" data-toggle="modal" data-target="#EditAccountCredentialsForm">Edit Credentials</button>
...
<div id="EditAccountCredentialsForm" class="modal fade" role="dialog" style="display: none;">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<div class="modal-title">
					<button type="button" class="btn close" data-dismiss="modal">×</button>
					<h4>Edit Account Creds Details</h4>
				</div>
			</div>
			<div class="modal-body">
				{!! Form::open(['method' => 'POST', 'url' => '/user/account/update/' , 'id' => $access_token]) !!}
				<br>
