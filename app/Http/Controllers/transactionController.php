...
class transactionController extends Controller
{
    public function index(){
        ...
        $transactions = DB::table('transactions')
                             ->join('bank_accounts','bank_accounts.id','=','transactions.bank_accounts_id')
                             ->select('transactions.*','bank_accounts.name AS b_name','bank_accounts.bank_name')
    ...
    public function createTransaction(Request $request){
        ...
        $newTransaction['date'] = $_POST['transactionDate'];
        ...
        $accountController->updateTotals($_POST['accountID'], $_POST['amount']);
