...
Route::group(['middleware' => ['web']], function () {
    ...
    Route::get('user/dashboard',['middleware' => 'auth', 'uses' => 'transactionController@index']);
    ...
    // Route::get('user/account',['middleware' => 'auth', 'uses' => 'accountController@getAccounts']);
    ...
    Route::get('user/account/hide_toggle/{id}',['middleware' => 'auth', 'uses' => 'accountController@hideToggle']);
    ...
    Route::get('user/account/sync/{id}',['middleware' => 'auth', 'uses' => 'accountController@syncSingleAccount']);
